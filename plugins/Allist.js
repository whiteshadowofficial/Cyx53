...
// send a list message!
    const rows = [
        {title: '📑මූලික උදව් | 👩‍🦰HELP-LIST', description: "⚙Bot පිළිබද අවබෝධයක් සහ මූලික උදව්.", rowId:"rowid1"},
        ...
        {title: '📑ඇනිම් ලැයිස්තුව | 👩‍🦰ANIME-LIST', description: "⚙Ramdom ඇනිම් ලැයිස්තුව |  👩‍🦰ANIME-LIST", rowId:"👩‍🦰ANIME-LIST"},
