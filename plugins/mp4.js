...
if (Config.WORKTYPE == 'private') {
    ...
    amazone.addCommand({ pattern: 'mp4 ?(.*)', fromMe: true, desc: YTV_DESC,  deleteCommand: false}, async (message, match) => {
    ...
    amazone.addCommand({ pattern: 'mp4 ?(.*)', fromMe: false, desc: MP4}, async (message, match) => {
